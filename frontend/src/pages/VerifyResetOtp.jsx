...
import { Loader2, ArrowRight, RefreshCw, ArrowLeft } from 'lucide-react';
...
const VerifyResetOtp = () => {
  ...
  const { verifyResetOtp, forgotPassword } = useAuth(); // Reuse forgotPassword for resending
  ...
  const handleResend = async () => {
    if (timer > 0) return;
    setIsResending(true);
    await forgotPassword(email); // Re-sends the OTP
    setTimer(60);
