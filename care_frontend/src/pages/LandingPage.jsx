...
export default function LandingPage() {
  ...
  const faqData = [
    ...
    },
    {
      ...
      a: "The API Layer operates on a separate developer portal (https://meditrack-facilityapi.vercel.app/). Click the 'API Layer' button in the navbar or footer to access integration keys and documentation."
    },
    {
  ...
  return (
    <div className="min-h-screen w-full bg-[var(--bg-main)] text-[var(--text-main)] flex flex-col relative selection:bg-teal-600 selection:text-white overflow-x-hidden transition-colors duration-300 font-sans">
      ...
      <header className="w-full sticky top-2 sm:top-3 z-50 px-2 sm:px-6 lg:px-8">
        <div className="w-full max-w-[1536px] mx-auto bg-[var(--nav-bg)] backdrop-blur-2xl border border-[var(--border-card)] px-3 sm:px-6 py-2.5 sm:py-3 rounded-full shadow-xl flex items-center justify-between transition-colors duration-300">
          ...
          <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8 text-xs font-bold text-[var(--text-muted)]">
          ...
          <div className="flex items-center space-x-2 sm:space-x-3 shrink-0">
            ...
            <button
              ...
              className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[var(--bg-pill)] border border-[var(--border-card)] flex items-center justify-center text-[var(--text-main)] hover:border-teal-500 transition-all shadow-sm shrink-0"
            ...
            <a
              href="https://meditrack-facilityapi.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold rounded-full border border-teal-500/40 bg-teal-500/10 text-teal-600 dark:text-teal-400 hover:bg-teal-500/20 hover:border-teal-500 transition-all shadow-sm shrink-0"
              title="Open MediTrack Facility API Portal"
            >
            ...
            <Link
              to="/admin/login"
              className="hidden md:inline-flex items-center gap-1.5 text-xs font-bold text-[var(--text-muted)] hover:text-[var(--text-main)] transition-colors px-3 py-2 rounded-full border border-[var(--border-card)] bg-[var(--bg-pill)] shrink-0"
            >
            ...
            <Link
              ...
              className="hidden sm:inline-flex btn-arrow-primary text-xs py-1 px-4.5 justify-center items-center shrink-0"
            >
              <span className='px-2'>Access Portal</span>
            ...
            <button
              ...
              className="lg:hidden w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[var(--bg-pill)] border border-[var(--border-card)] flex items-center justify-center text-[var(--text-main)] hover:border-teal-500 transition-all shrink-0"
            ...
            <div className="pt-3 border-t border-[var(--border-card)] flex flex-col space-y-2">
              ...
              <div className="flex items-center gap-2 pt-1">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="flex-1 flex items-center justify-center gap-1.5 px-4 py-2 text-xs font-bold rounded-full border border-teal-500/30 bg-teal-500/10 text-teal-500 hover:bg-teal-500/20 transition-all"
                >
                  <FileCode2 className="w-3.5 h-3.5" />
        ...
        <section className="w-full relative rounded-[36px] overflow-hidden mb-16 border border-[var(--border-card)] shadow-2xl bg-slate-950 text-white min-h-[580px] lg:min-h-[640px] flex flex-col justify-between p-8 md:p-14 reveal-on-scroll">
          ...
          <div className="relative z-10 flex items-center justify-between">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden md:inline-flex items-center gap-1.5 bg-white/10 hover:bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/20 text-xs font-semibold text-white transition hover:border-white/40"
            >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-emerald-200">
            ...
            <div className="flex items-center space-x-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-white transition font-bold underline flex items-center gap-1"
              >
                <span>Enterprise API Layer</span>
                <ArrowUpRight className="w-3 h-3" />
              </a>
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border-card)] rounded-[32px] p-8 max-w-lg w-full shadow-2xl relative animate-in fade-in zoom-in duration-200">
            ...
            <div className="p-4 rounded-2xl bg-[var(--bg-pill)] border border-[var(--border-card)] text-xs space-y-2 mb-6 font-mono">
              <div className="flex items-center justify-between text-[11px] font-bold text-[var(--text-main)]">
                <span>API Base Endpoint & Developer Portal</span>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[11px] text-teal-600 dark:text-teal-400 bg-[var(--bg-main)] p-2.5 rounded-xl block truncate border border-[var(--border-card)] hover:border-teal-500 transition font-semibold"
              >
                https://meditrack-facilityapi.vercel.app/
              </a>
            </div>
            ...
            <div className="flex items-center justify-end space-x-3">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setShowApiModal(false)}
                className="btn-arrow-primary text-xs py-2.5 px-5 inline-flex items-center"
              >
